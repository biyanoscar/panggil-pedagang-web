            ...
            <div class="col-12">
                ...
                <div class="card card-primary">
                    ...
                    <form action="/admin/categories/update/<?= $category['category_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="imgLama" value="<?= $category['category_img']; ?>">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="category_name">Category name</label>
                                <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Enter name" value="<?= (old('category_name')) ? old('category_name') : $category['category_name']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="category_img"><?= $category['category_img']; ?></label>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <img src="/images/categories/<?= $category['category_img']; ?>" class="img-thumbnail img-preview">
                                </div>
